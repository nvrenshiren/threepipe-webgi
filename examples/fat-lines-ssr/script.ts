...
async function init() {
  const viewer = new ThreeViewer({
    ...
    msaa: true,
    plugins: [LoadingScreenPlugin, ProgressivePlugin, GBufferPlugin, BloomPlugin, SSReflectionPlugin, TemporalAAPlugin, PickingPlugin, BaseGroundPlugin],
    dropzone: true
  })
